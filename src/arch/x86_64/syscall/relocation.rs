...
fn get_stub_symbol(name: &str) -> Option<usize> {
    ...
    static STUB_SYMBOLS: phf::Map<&'static str, fn() -> usize> = phf_map! {
        "_dl_find_object" => || _dl_find_object as usize,
        "_dl_audit_preinit" => || _dl_audit_preinit as usize,
        "_dl_find_dso_for_object" => || _dl_find_dso_for_object as usize,
        "_dl_allocate_tls" => || _dl_allocate_tls as usize,
        "_dl_allocate_tls_init" => || _dl_allocate_tls_init as usize,
        "_dl_deallocate_tls" => || _dl_deallocate_tls as usize,
        "_dl_signal_error" => || _dl_signal_error as usize,
        "_dl_signal_exception" => || _dl_signal_exception as usize,
        "_dl_catch_exception" => || _dl_catch_exception as usize,
        "_dl_catch_error" => || _dl_catch_error as usize,
        "_dl_audit_symbind_alt" => || _dl_audit_symbind_alt as usize,
        "_dl_rtld_di_serinfo" => || _dl_rtld_di_serinfo as usize,
        "__tunable_is_initialized" => || __tunable_is_initialized as usize,
        "__tunable_get_val" => || __tunable_get_val as usize,
        "__tls_get_addr" => || __tls_get_addr as usize,
        "dlopen" => || dlopen as usize,
        "dlsym" => || dlsym as usize,
        "dlvsym" => || dlvsym as usize,
        "dlclose" => || dlclose as usize,
        "dlerror" => || dlerror as usize,
        "dladdr" => || dladdr as usize,
        "dladdr1" => || dladdr1 as usize,
        "dl_iterate_phdr" => || dl_iterate_phdr as usize,
        "is_selinux_enabled" => || is_selinux_enabled as usize,
        "freecon" => || freecon as usize,
        "getcon" => || getcon as usize,
        "getfilecon" => || getfilecon as usize,
        "lgetfilecon" => || lgetfilecon as usize,
        "getfilecon_raw" => || getfilecon_raw as usize,
    };
